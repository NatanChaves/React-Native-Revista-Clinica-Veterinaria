...
export default class MagazineOffline extends Component {
    ...
    deletePubOffline = async () => {
        ...
        try {
            await FileSystem.deleteAsync(FileSystem.documentDirectory + 'app_docs/pdfs/' + `revista-clinica-veterinaria-${this.state.NREdicao}.pdf`);
    ...
    deleteCover = async () => {
        ...
        try {
            await FileSystem.deleteAsync(FileSystem.documentDirectory + 'app_docs/covers/' + `revistaclinicavet,${this.state.NREdicao}.jpg`);
            ...
            <>
                ...
                <View style={{ flex: 6 }}>
                    <PDFReader
                        ...
                        withPinchZoom={true}
                        source={{
                            uri: `${FileSystem.documentDirectory + 'app_docs/pdfs/'}revista-clinica-veterinaria-${this.state.NREdicao}.pdf`
                        }}
                    />
                </View>
