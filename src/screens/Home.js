...
export default class Home extends Component {
    ...
    openEdicao = (NREdicao, IDEdicao, UrlAmazon) => {
        this.props.navigation.push("Magazine", { NREdicao: NREdicao, IDEdicao: IDEdicao, UrlAmazon: UrlAmazon })
    }
                                            ...
                                            <>
                                                <View style={style.containerCover} >
                                                    <TouchableOpacity onPress={() => this.openEdicao(item.NREdicao, item.IDEdicao, item.UrlAmazon)}>
                                                        <Image style={style.cover} source={{ uri: `https://revistaclinicaveterinaria.com.br/assets/img/capas/clinica-veterinaria-${item.NREdicao}.jpg` }} />
                                                    </TouchableOpacity>
                                                    <Text style={style.caption}>N. {item.NREdicao}</Text>
                                                    <Button title={translate('readon')} onPress={() => this.openEdicao(item.NREdicao, item.UrlAmazon)} buttonStyle={{backgroundColor: '#00a5b5', borderRadius: 10}} titleStyle={{color: '#fff'}} />
                                                </View>
                                            </>
                                        )
                                    }}
